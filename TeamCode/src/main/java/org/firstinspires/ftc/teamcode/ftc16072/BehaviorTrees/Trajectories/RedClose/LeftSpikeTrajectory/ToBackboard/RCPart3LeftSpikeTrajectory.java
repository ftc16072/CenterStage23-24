package org.firstinspires.ftc.teamcode.ftc16072.BehaviorTrees.Trajectories.RedClose.LeftSpikeTrajectory.ToBackboard;
...
public class RCPart3LeftSpikeTrajectory extends Node {

    //EDIT (as of 2/18)
    public static final int FORWARD_DISTANCE_INCHES=44;

    @Override
    public State tick(QQOpMode opMode) {
        TrajectorySequenceBuilder builder = opMode.robot.nav.trajectorySequenceBuilder(opMode.robot.nav.getPoseEstimate());
        TrajectorySequence sequence = builder.strafeLeft(FORWARD_DISTANCE_INCHES).
                                            build();
        if (sequence == null){
