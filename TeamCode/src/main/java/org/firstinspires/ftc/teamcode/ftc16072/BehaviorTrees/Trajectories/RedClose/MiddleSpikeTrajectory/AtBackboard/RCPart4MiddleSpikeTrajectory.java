package org.firstinspires.ftc.teamcode.ftc16072.BehaviorTrees.Trajectories.RedClose.MiddleSpikeTrajectory.AtBackboard;
...
public class RCPart4MiddleSpikeTrajectory extends Node {
    //EDIT (as of 2/18)
    public static final int STRAFELEFT_DISTANCE_INCHES=2;

    @Override
    public State tick(QQOpMode opMode) {
        TrajectorySequenceBuilder builder = opMode.robot.nav.trajectorySequenceBuilder(opMode.robot.nav.getPoseEstimate());
        TrajectorySequence sequence = builder.strafeRight(STRAFELEFT_DISTANCE_INCHES).
                                            build();
        if (sequence == null){
