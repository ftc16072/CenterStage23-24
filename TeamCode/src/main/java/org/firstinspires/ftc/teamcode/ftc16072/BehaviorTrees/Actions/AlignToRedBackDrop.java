...
public class AlignToRedBackDrop extends Node {
    ...
    public State tick(QQOpMode opmode) {
        ...
        double  drive           = .3;        // Desired forward power/speed (-1 to +1)
        double  strafe          = .3;        // Desired strafe power/speed (-1 to +1)
        double  turn            = .3;        // Desired turning power/speed (-1 to +1)
